...
<style>
  ...
  .see-all { font-size: 0.8rem; color: rgba(250,248,245,0.5); transition: color 0.15s; }
  ...
  .recent-shot:hover {
    border-color: rgba(196, 135, 74, 0.4);
    transform: translateY(-4px);
  ...
  .recent-bean { font-size: 0.9rem; font-weight: 500; color: var(--coffee-light); }
